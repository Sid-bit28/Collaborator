    ...
    <div className="flex items-center justify-center flex-col">
      ...
      >
        ...
        <h1 className="text-3xl md:text-6xl text-center text-neutral-800">
          Collaborator helps team move
        </h1>
        <div
          className="text-3xl md:text-6xl bg-gradient-to-r from-fuchsia-600 to-pink-600 text-white px-4 p-2 rounded-md py-4 mt-5"
          w-fit
        >
          Work Forward.
        </div>
      ...
      >
        ...
        it all with Collaborator.
      </div>
      <Button className="mt-6" size="lg" asChild>
        <Link href="/sign-up">Get Collaborator for free</Link>
      </Button>
    </div>
  );
};
